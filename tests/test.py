...
assert exp == [4.953032424395115, 13.873769902129904, 17.993309601550315, 27.938341703236507, 68.03348428941966, 102.51406411049346]
...
fibbands = ta.fibbands([[1,59],[1.1,82],[1.21,27],[1.42,73],[1.32,42]], 4, 2);

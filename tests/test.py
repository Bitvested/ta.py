...
rv = ta.rvi([[4,6,3,3], [3,5,2,2], [2,5,2,4], [4,6,4,5], [5,7,4,4], [4,6,3,4], [4,7,3,5], [5,7,5,6], [6,8,6,6], [6,9,5,6], [6,8,6,7], [7,9,5,6],[6,7,4,5],[5,6,5,6],[6,8,5,5],[5,7,2,6]],8);
assert rv == [0.29878048780487804,0.21951219512195122,0.1589403973509934,0.16083916083916086,0.09859154929577463,0.05109489051094891];
rvs = ta.rvi_signal([0.29878048780487804,0.21951219512195122,0.1589403973509934,0.16083916083916086,0.09859154929577463,0.05109489051094891]);
